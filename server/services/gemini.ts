...
1. AUTHENTIC COMMUNICATION: Create frames that students will actually use in real-world conversations about "${text}". They should sound natural, not contrived or overly academic.

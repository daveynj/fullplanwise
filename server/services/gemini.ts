          ...
          for (const word of section.words) {
            ...
            if (word.imagePrompt) {
               try {
                 ...
                 word.imageBase64 = await replicateImageService.generateImage(word.imagePrompt, requestId);
          ...
          for (const question of section.questions) {
            ...
            if (question.imagePrompt) {
               try {
                 ...
                 question.imageBase64 = await replicateImageService.generateImage(question.imagePrompt, requestId);

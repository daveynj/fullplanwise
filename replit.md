...
- January 31, 2025: Upgraded image generation from FLUX Schnell to Google Imagen-4-Fast via Replicate API - improved image quality and generation speed by switching from black-forest-labs/flux-schnell to google/imagen-4-fast model, updated service parameters for optimal 1024x1024 PNG output, enhanced logging and error messages throughout the image generation workflow

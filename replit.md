...
- **AI Service Integration**: Primary AI (Claude Sonnet 4 via OpenRouter) for intelligent lesson generation, operating with trusted output to eliminate post-generation validation and dynamically loading services.
